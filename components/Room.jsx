                    ...
                    <div className='flex justify-end gap-6 px-10 py-2'>
                        <div className='flex flex-col items-center'>
                            ...
                            <div className='flex gap-2'>
                                <img src="../../../public/png1.png" className='w-6 h-6' alt="#" />
                                <span>1</span>
                            </div>
                        </div>
                        <div className='flex flex-col items-center'>
                            ...
                            <div className='flex gap-2'>
                                <img src="../../../public/png2.png" className='w-6 h-6' alt="#" />
                                <span>2</span>
                            </div>
                        </div>
                        <div className='flex flex-col items-center'>
                            ...
                            <div className='flex gap-2'>
                                <img src="../../../public/png3.png" className='w-6 h-6' alt="#" />
                                <span>9</span>
                            </div>
                        </div>
                        <div className='flex flex-col items-center col-span-2'>
                            ...
                            <div className='flex gap-2'>
                                <img src="../../../public/png4.png" className='w-6 h-6' alt="#" />
